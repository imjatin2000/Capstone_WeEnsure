...
# MAGIC %md
# MAGIC ###check for the total premium generated by the agent using widget
# MAGIC
...
# MAGIC %md
# MAGIC ### average policy duration by particular plan_id
...
# MAGIC %md
# MAGIC ###Payment History by particular policy_number
...
# MAGIC %md
# MAGIC ###claims approved by selected treatment
...
# MAGIC %md
# MAGIC ###Number of Claims by specific Treatment Type
